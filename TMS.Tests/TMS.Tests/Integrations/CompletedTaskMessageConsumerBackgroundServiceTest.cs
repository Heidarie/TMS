...
{
    public class CompletedTaskMessageConsumerBackgroundServiceTest(ConnectionFactory factory, RabbitMqOptions options, ILogger<CompletedTaskMessageConsumerBackgroundService> logger, ConcurrentBag<TaskCompletedMessage> concurrentBag) : BackgroundService
    {
